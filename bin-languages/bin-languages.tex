...
The general idea of how to prove membership in $\Lang_{[\matr{M}]_1,[\matr{N}]_1,\matr{\Lambda},\grkb{\alpha}}$ is explained in Section~\ref{sec:techniques}. As we discussed there the total size of the proof is of size $2\lb|\GG_1|+\Theta(1)$. The details of the proof can be found in Appendix~\ref{app:bin-lang}.
